...
var Product = React.createClass({
    ...
    upvote : function(){
        ...
        this.serverRequest = $.post('http://localhost:3000/products/' + product.Slug + '/feedback', {vote : 1}, function (result) {
            this.props.product.Voted = "UpVoted"
        }.bind(this));
    },
    downvote: function(){
        var product = this.props.product;
        this.serverRequest = $.post('http://localhost:3000/products/' + product.Slug + '/feedback', {vote : -1}, function (result) {
            this.props.product.Voted = "DownVoted"
        }.bind(this));
    },
    // getInitialState: function() {
    //     return {
        ...
        return(
            <div className="col-xs-4">
                <div className="panel panel-default">
                    <div className="panel-heading">{this.props.product.Name} <span className="pull-right">{this.props.product.Voted}</span></div>
